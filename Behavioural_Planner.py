...
class BehaviouralPlanner:
    ...
    def transition_state(self, waypoints, ego_state, closed_loop_speed):
        ...
        if self._state == FOLLOW_LANE:
            ...
            # ------------------------------------------------------------------
            print("Stop Sign Detection Status = %d" % stop_sign_found)
            pass
        ...
        # state.
            ...
            print("Vehicle Decelerating to Stop...")
            # ------------------------------------------------------------------
            if closed_loop_speed > STOP_THRESHOLD:
                self._state = DECELERATE_TO_STOP
                print("Closed Loop Speed = %f" % closed_loop_speed)
                print("State of Vehicle: " + str(ego_state))
            else:
                self._state = STAY_STOPPED
                print("Vehicle Preparing to Stop...")
            # ------------------------------------------------------------------
            pass
        ...
        # the stop sign and transition to the next state.
            ...
            if self._stop_count == STOP_COUNTS:
                print("Vehicle Preparing to Resume Lane Tracking...")
                # --------------------------------------------------------------
                closest_len, closest_index = get_closest_index(waypoints, ego_state)
                goal_index = self.get_goal_index(waypoints, ego_state, closest_len, closest_index)
                # --------------------------------------------------------------
