...
class Controller(object):
    ...
    def update_controls(self):
        ...
        ######################################################
        self.vars.create_var('kp', 1.50)
        self.vars.create_var('ki', 1.20)
        self.vars.create_var('kd', 0.08)
        self.vars.create_var('integrator_min', 0.0)
        self.vars.create_var('integrator_max', 10.0)
        self.vars.create_var('k_cte', 7.7)
        self.vars.create_var('k_speed', 1.2)
        self.vars.create_var('k_soft', 0.001)
        ...
        if self._start_control_loop:
            ...
            steer_output = heading_error + \
                    np.arctan(self.vars.k_cte * \
                              crosstrack_sign * \
                              crosstrack_error / \
                              (self.vars.k_soft + self.vars.k_speed*v))
